...
// func DeleteMenu() {
// 	err = menu.Delete(msgClient)
// 	if err != nil {
// 		log.Println("Error : ", " Delete Menu Error ! ", err)
// 	}
// }
// "============================================
// ============================================
...
// 	//绝对路径
// 	jsonpath, _ := filepath.Abs(fileName)
...
// 	var Menu_wx *menu.Menu
// 	Menu_wx = new(menu.Menu)
// 	Menu_wx, test, err := menu.Get(client)
// 	if err != nil {
// 		fmt.Println("Error GetMenu:", err)
// 	}
// 	fmt.Println("Get Menu:", Menu_wx, test)
// }
